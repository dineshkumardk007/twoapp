    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          ...
          <button
            onClick={() => onNavigate('stateofunion')}
            className="text-left p-4 rounded-2xl border border-amber-300/90 bg-gradient-to-br from-amber-50/60 to-yellow-50/30 hover:bg-amber-100/50 transition-colors cursor-pointer group"
          >
